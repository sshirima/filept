...
class Account(models.Model):
    ...
    auth_type = models.CharField(max_length = 20,choices = AUTH_TYPE_CHOICES,blank=True, null=True)
...
class System(models.Model):
    ...
    accounts = models.ManyToManyField(Account, through="SystemAccount")
...
class SystemAccount(models.Model):
    ...
    def __str__(self):
        return self.account.username + ":" + self.system.title
